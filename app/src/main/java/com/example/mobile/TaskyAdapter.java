...
public class TaskyAdapter extends RecyclerView.Adapter<TaskyAdapter.TaskVH> {

    Context context;
    ArrayList<Task> lstTask;
    TaskyCallback taskCallback;
    public void setCallback(TaskyCallback taskCallback) {
        this.taskCallback = taskCallback;
    }
    public TaskyAdapter (ArrayList<Task> lstTask,Context context) {
    ...
    public void onBindViewHolder(@NonNull TaskVH holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> taskCallback.onItemViewClicky(item,position));
        holder.btnYeuthich.setOnClickListener(view -> taskCallback.onItemYeuthichClickedy(item,position));
        holder.btnTap.setOnClickListener(view -> taskCallback.onItemTapClickedy(item,position));
    }
    ...
    public  interface  TaskyCallback{
        void onItemViewClicky(Task task,int position);
        void onItemYeuthichClickedy(Task task, int position);
        void onItemTapClickedy(Task task, int position);
    }
}
